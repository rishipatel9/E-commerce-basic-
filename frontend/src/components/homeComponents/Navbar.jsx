...
export default function Navbar() {
  return (
    <div className="flex h-16 w-dvw border-rose-500 gap-20 justify-around  bottom-0 absolute top-0 shadow to-black pt-3 pb-3 px-5 z-10">
      <div className="flex justify-center items-center">
        <img className="h-24" src={image} alt="" />
      </div>
      <div className="flex h-8 justify-between gap-5 items-center border-slate-500 self-center border-solid border-black" style={{"border":"1px solid #E4E4E4"}} >
        <div>
